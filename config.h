...
//#define CPU_MAP_ATMEGA328P_4AXIS // Arduino Uno CPU
//#define N_AXIS 3   //3 Axis configuration. Must be compatible with DEFAULTS and CPU_MAP

#define CPU_MAP_ATMEGA328P_4AXIS //Err, will require some re-arrangement but should work.
...
/// Inverts the pwm duty cycle of the spindle enable for variable spindle so 0% spindle is ~5V
#define VARIABLE_SPINDLE_INVERTED
...
// COMPILE-TIME ERROR CHECKING OF DEFINE VALUES:
  ...
  #ifndef CPU_MAP_ATMEGA328P_4AXIS 
